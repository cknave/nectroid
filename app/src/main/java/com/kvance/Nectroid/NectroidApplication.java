    ...
    implements OnSharedPreferenceChangeListener, SiteManager.SiteListener
{
    ...
    public FavoritesManager getFavoritesManager() { return mFavoritesManager; }
    ...
    {
        return mFavoritesManager.isUpdating() ||
                mPlaylistManager.isUpdating() ||
