...
class Cache
{
    ...
    private static String user = "djrandom";
    ...
    public static URL getUrlForDocId(DocId id, Context ctx)
    {
        ...
        switch(id) {
            ...
            case FAVORITES:
                ...
                urlSuffix = ctx.getString(R.string.url_favorites);
                if (user != null) {
                    urlSuffix = urlSuffix.replaceAll("USER", user);
                }
                //System.out.println("FAVS URLS="+urlSuffix);
                break;
    ...
    public static String getFilenameForDocId(DocId id, Context ctx)
    {
        switch(id) {
            ...
            case FAVORITES:
                return ctx.getString(R.string.filename_favorites);
        }
