...
public class NectroidActivity extends Activity
    ...
    private LinearLayout whatyousayLayout;
    private TextView historyButton;
    private TextView favoritesButton;
    private TextView queueButton;
    private TextView whatyousayButton;
    private EditText whatyousayEditText;
    ...
    public void onTaskFailed(Object manager) {
        ...
        } else if (managerClass == FavoritesManager.class) {
            stringId = R.string.favorites_failed;
        } else if (managerClass == OneLinerManager.class) {
    ...
    /**
     * The "favorites" link was clicked
     */
    private OnClickListener onFavoritesClicked = new OnClickListener() {
        public void onClick(View widget) {

            Activity us = NectroidActivity.this;
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("nectroid://favorites"));
            intent.setClass(us, FavoritesActivity.class);
            startActivity(intent);
            Transition.set(us, R.anim.slide_in_right, R.anim.slide_out_left);
     ...
     * The "favorites" link was clicked
     */
    private OnClickListener onWhatYouSayClicked = new OnClickListener() {
        public void onClick(View widget) {
            String text = whatyousayEditText.getText().toString();
...
// Find the base URL for the current site.
                ...
                HttpPost post = new HttpPost(baseUrl+NectroidActivity.this.getString(R.string.url_whatyousay));
                System.out.println("WHATYOUSAY URL="+baseUrl+NectroidActivity.this.getString(R.string.url_whatyousay));
                List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(1);
                nameValuePairs.add(new BasicNameValuePair(NectroidActivity.this.getString(R.string.parameter_line), text));
                ...
                Toast.makeText(NectroidActivity.this, "whatyousay=" + text, Toast.LENGTH_LONG).show();
                whatyousayEditText.getText().clear();
                mOneLinerManager.update(NectroidActivity.this, false);
            } catch (Exception e) {
                Toast.makeText(NectroidActivity.this, "Could not whatyousay error=" + e, Toast.LENGTH_LONG).show();
            }
        }
    };
    ...
    public static boolean findLineInStream(BufferedReader rd, String tofind, String stopIfFound) throws IOException {

            String line = "";
            while ((line = rd.readLine()) != null) {
                if (tofind != null && line.trim().contains(tofind)) {
                    return true;
                } else if (stopIfFound != null && line.trim().contains(stopIfFound)) {
                    return false;
                }
            }
            rd.close();
    ...
    /**
     * The "login" link was clicked
     */
    private OnClickListener onLogInClicked = new OnClickListener() {
        public void onClick(View widget) {

            String login = Prefs.getLogin(NectroidActivity.this);
            String password = Prefs.getPassword(NectroidActivity.this);

            if (login == null || password == null) {
                Toast.makeText(NectroidActivity.this, "Cannot login: your login is not set in preferences.", Toast.LENGTH_LONG).show();
                Intent settingsActivity = new Intent(NectroidActivity.this, SettingsActivity.class);
                startActivity(settingsActivity);
                return;
            }
            if (password == null) {
                Toast.makeText(NectroidActivity.this, "Cannot login: your password is not set in preferences.", Toast.LENGTH_LONG).show();
                Intent settingsActivity = new Intent(NectroidActivity.this, SettingsActivity.class);
                startActivity(settingsActivity);
                return;
            }
            ...
            if (whatyousayLayout.getVisibility() == LinearLayout.VISIBLE) {
                // DefaultHttpClient client = null;
                try {

                    HttpPost post = new HttpPost(baseUrl+NectroidActivity.this.getString(R.string.url_logout));
                    System.out.println("LOGOUT URL="+baseUrl+NectroidActivity.this.getString(R.string.url_logout));
                    ...
                    if (findLineInStream(rd, "Welcome, " + login, "Welcome, Visitor!")) {
                        Toast.makeText(NectroidActivity.this, "Could not log out with login=" + login, Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(NectroidActivity.this, "Logged out", Toast.LENGTH_LONG).show();
                        whatyousayLayout.setVisibility(LinearLayout.INVISIBLE);
                        favoritesButton.setVisibility(LinearLayout.INVISIBLE);
                        loginButton.setText("Log in");

                        Cache.setUser(null);
                    }
                } catch (Exception e) {
                    Toast.makeText(NectroidActivity.this, "Cannot login: with error " + e, Toast.LENGTH_LONG).show();
                    return;
                } finally {
                ...
                // DefaultHttpClient client = null;
                try {
                    HttpPost post = new HttpPost(baseUrl+NectroidActivity.this.getString(R.string.url_login));
                    System.out.println("LOGIN_KEY URL="+baseUrl+NectroidActivity.this.getString(R.string.url_login));
                    List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(1);
                    nameValuePairs.add(new BasicNameValuePair(NectroidActivity.this.getString(R.string.parameter_username), login));
                    nameValuePairs.add(new BasicNameValuePair(NectroidActivity.this.getString(R.string.parameter_password), password));
                    post.setEntity(new UrlEncodedFormEntity(nameValuePairs));
                    ...
                    if (findLineInStream(rd, "Welcome, " + login, "Welcome, Visitor!")) {
                        Toast.makeText(NectroidActivity.this, "Logged as " + login, Toast.LENGTH_LONG).show();
                        whatyousayLayout.setVisibility(LinearLayout.VISIBLE);
                        favoritesButton.setVisibility(LinearLayout.VISIBLE);
                        loginButton.setText("Log out");
                        Cache.setUser(login);
                    } else {
                        Toast.makeText(NectroidActivity.this, "Could not log (still visitor) in with login=" + login, Toast.LENGTH_LONG).show();
                    }
                } catch (Exception e) {
                    Toast.makeText(NectroidActivity.this, "Cannot login: with error " + e, Toast.LENGTH_LONG).show();
                    return;
    ...
    private void createWidgets() {
        ...
        queueButton = (TextView) findViewById(R.id.queue_button);
        queueButton.setMovementMethod(lmm);
        queueButton.setOnClickListener(onQueueClicked);

        //hide WHATYOUSAY LAYOUT
        whatyousayLayout = (LinearLayout) findViewById(R.id.whatyousay_layout);
        whatyousayLayout.setVisibility(LinearLayout.INVISIBLE);

        whatyousayButton = (TextView) findViewById(R.id.whatyousay_button);
        whatyousayButton.setMovementMethod(lmm);
        whatyousayButton.setOnClickListener(onWhatYouSayClicked);

        whatyousayEditText = (EditText) findViewById(R.id.whatyousay_edittext);
        whatyousayEditText.setOnKeyListener(new View.OnKeyListener(){
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if ((event.getAction() == KeyEvent.ACTION_DOWN) &&
                    ...
                    onWhatYouSayClicked.onClick(whatyousayButton);
        ...
        favoritesButton = (TextView) findViewById(R.id.favorites_button);
        favoritesButton.setMovementMethod(lmm);
        favoritesButton.setOnClickListener(onFavoritesClicked);
        favoritesButton.setVisibility(LinearLayout.INVISIBLE);

        loginButton = (TextView) findViewById(R.id.login_button);
        loginButton.setMovementMethod(lmm);
